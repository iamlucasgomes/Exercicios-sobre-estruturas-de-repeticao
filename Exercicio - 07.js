...
function soma(numeros) {
  // criei uma função que recebeu o nome soma e o parametro numeros, onde vamos colocar nossa sequencia numérica que deve ser somada
  ...
  for (var contador = 1; contador < numeros.length; contador++) {
    // usei a estrutura de repetição para repetir até o limite definido por numeros.length
