...
function tabuadaMultiplicacao(numeros,multiplicador){ // criei um função e determinei 2 parâmetros para ela, a lista de numeros e o multiplicador
      
    var resultado = []; // criei uma variável com um array vazio para receber o resultado da nossa estrutura de repetição
for (var indice = 0; indice < numeros.length; indice ++){ // usei uma estrutura de repetição onde vamos repetir a operação abaixo ate o limite determinado por numeros.length
