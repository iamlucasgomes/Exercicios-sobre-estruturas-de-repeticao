...
function tabuadaImpar(numeros, multiplicador) {
  // criei uma função que vai receber 2 paramêtros, um deles é a array numeros onde vamos inserir os numeros que queremos multiplicar pelo multiplicador
  ...
  for (var indice = 0; indice < numeros.length; indice++) {
    // usei a estrutura de repetição que vai verificar todos os elementos da array numeros a partir do seu primeiro elemento
    if ((numeros[indice] * multiplicador) % 2 !== 0) {
      //	e se(if) o elemento da array numeros for multiplicado pelo multiplicador e tiver o resto diferente de 0
