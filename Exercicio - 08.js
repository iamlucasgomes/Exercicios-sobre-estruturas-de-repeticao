...
function somaEMediaDeIdades(idade) {
    ...
    for (i = 0; i < idade.length; i++) {
      // usei a estrutura de repetição e defini um limite de repetição baseado no comprimento de idade
      if (idade[i] >= 18) {
        // usei a estrutura condicional, e defini a condição se o elemento de idade for maior ou igual a 18
    ...
    return (
      'A soma das pessoas maiores de idade é: ' +
      soma +
      ' e a média de idades informadas é:  ' +
      media
    ); // declarei o retorno da soma e média concatenando com uma String para ter um resultado mais explicativo
  }
